...
namespace RoundedTask
{
    ...
    internal sealed class SettingsForm : Form
    {
        ...
        public SettingsForm(AppSettings settings)
        {
            ...
            Panel behaviorPanel = MakeCard(18, 704, 524, 132);
            ...
            _translucentTb = MakeCheck("Compatibilidade com TranslucentTB", settings.TranslucentTbCompatibility, 22, 102);
            ...
            behaviorPanel.Controls.AddRange(new Control[] { _fillMaximized, _fillTaskSwitcher, _showTraySegment, _showTrayOnHover, _translucentTb, _dpiScaling });

            Button restore = MakeButton("Restaurar", 18, 850, ButtonStyle.Secondary);
            ...
            Button close = MakeButton("Fechar", 434, 850, ButtonStyle.Primary);
        ...
        private void OnLiveControlChanged(object sender, EventArgs e)
        {
            ...
            if (sender == _layout || sender == _fillMaximized || sender == _showTrayOnHover)
            {
                UpdateControlStates();
            }
